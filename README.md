...
- **Listado del alumnado** con:
  ...
  - Filtros desplegables por Curso, Especialidad, **Diagnóstico** y Curso Académico (por defecto el actual).
  - Orden por defecto Prioritario → Cerrado, con filas tintadas según el estado.
  - Columna de **Diagnóstico**: se ve el primero y un `+N` que enumera el resto al pasar el ratón.
...
- **Pestaña Estadística** con 11 bloques, dos de ellos listas de trabajo —**autorizados para contactar con el ERG a quien nadie ha contactado** y **alumnado sin ninguna actuación**— y el resto: distribución por seguimiento, actuaciones del mes/curso, pendientes propios, alertas de prioritarios sin actuación reciente, distribuciones por curso/especialidad/diagnóstico —este **desglosado por curso**, con barra apilada de elementales contra profesionales y matriz diagnóstico × curso—, **casos por centro educativo**, **tipos de actuación**, **reparto de actuaciones por alumno** y actividad mensual del curso.
